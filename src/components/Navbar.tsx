    ...
    <div className={`fixed top-0 left-0 right-0 z-50 flex justify-center px-4 transition-all duration-500 pointer-events-none ${scrolled ? 'pt-4 pb-2' : 'pt-6'}`}>
      <nav className={`pointer-events-auto w-full max-w-7xl px-6 py-3 border rounded-2xl flex items-center justify-between transition-all duration-500 shadow-sm ${scrolled ? 'bg-white/90 backdrop-blur-xl border-zinc-200' : 'bg-white border-zinc-200'}`}>
        ...
        <div className="flex items-center gap-3">
          <Link href="/booking" className="hidden sm:flex bg-[#065f2e] hover:bg-[#04401f] text-white font-black uppercase tracking-wide px-6 py-2.5 rounded-xl text-xs transition-all items-center gap-2 shadow-sm hover:shadow-md hover:-translate-y-0.5">
              ...
              <SheetContent side="right" className="bg-white/95 backdrop-blur-3xl border-l border-zinc-200 w-[300px] sm:w-[400px]">
                <div className="flex flex-col h-full pt-10">
                  ...
                  <div className="mt-auto pb-8 space-y-4">
                    <Link href="/booking" className="w-full bg-[#065f2e] hover:bg-[#04401f] text-white font-black uppercase tracking-wide px-6 py-4 rounded-xl text-sm transition-all flex items-center justify-center gap-2 shadow-md">
                      <Calendar className="w-5 h-5" /> Book Your Slot Now
                    </Link>
                    <Link href="/about" className="w-full bg-zinc-100 hover:bg-zinc-200 text-zinc-900 border border-zinc-200 font-bold uppercase tracking-wide px-6 py-4 rounded-xl text-sm transition-all flex items-center justify-center gap-2">
